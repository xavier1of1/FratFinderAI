...
def test_doctor_reports_deprecated_runtime_and_agent_env_warning(monkeypatch):
    ...
    service = CrawlService(
        SimpleNamespace(
            ...
            crawler_search_dataforseo_login=None,
            crawler_search_dataforseo_password=None,
            crawler_search_searxng_base_urls="",
            crawler_search_searxng_engines="",
            ...
            crawler_search_preflight_cache_ttl_seconds=45,
