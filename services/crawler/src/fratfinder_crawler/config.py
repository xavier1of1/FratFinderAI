...
class Settings(BaseSettings):
    ...
    crawler_search_searxng_max_in_flight: int = Field(default=1, alias="CRAWLER_SEARCH_SEARXNG_MAX_IN_FLIGHT")
    crawler_search_searxng_min_interval_ms: int = Field(default=750, alias="CRAWLER_SEARCH_SEARXNG_MIN_INTERVAL_MS")
    crawler_search_searxng_backoff_seconds: int = Field(default=90, alias="CRAWLER_SEARCH_SEARXNG_BACKOFF_SECONDS")
    crawler_search_searxng_admission_wait_seconds: float = Field(default=10.0, alias="CRAWLER_SEARCH_SEARXNG_ADMISSION_WAIT_SECONDS")
    crawler_search_result_cache_ttl_seconds: int = Field(default=1800, alias="CRAWLER_SEARCH_RESULT_CACHE_TTL_SECONDS")
    crawler_search_preflight_cache_ttl_seconds: int = Field(default=45, alias="CRAWLER_SEARCH_PREFLIGHT_CACHE_TTL_SECONDS")
    ...
    crawler_search_searxng_engine_profile: str = Field(default="auto", alias="CRAWLER_SEARCH_SEARXNG_ENGINE_PROFILE")
    crawler_search_searxng_stable_engines: str | None = Field(default=None, alias="CRAWLER_SEARCH_SEARXNG_STABLE_ENGINES")
    crawler_search_searxng_rescue_engines: str | None = Field(default=None, alias="CRAWLER_SEARCH_SEARXNG_RESCUE_ENGINES")
